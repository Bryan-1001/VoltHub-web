  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/5 backdrop-blur-md bg-slate-950/75">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between gap-4 px-4 sm:px-6 md:h-16">
        ...
        <Link
          href="#download"
          className="inline-flex items-center justify-center rounded-full bg-[#10b981] px-3.5 py-2 text-xs font-semibold text-[#020617] transition hover:bg-[#34d399] md:px-5 md:py-2.5 md:text-sm"
        >
